                        ...
                        TradeDecision &dec)
{
   ...
   FileWrite(h,
      ...
      "",  // TradeID (пусто для сигнала)
      dir,
      // Scores агентов
      IntegerToString(signals[0].score),  // VWAP
      IntegerToString(signals[1].score),  // SD
      IntegerToString(signals[2].score),  // Structure
      IntegerToString(signals[3].score),  // Momentum
      DoubleToString(ctx.context_multiplier, 2),  // CtxMult
      IntegerToString(signals[5].score),  // WPR
      IntegerToString(signals[6].score),  // BV
      IntegerToString(signals[7].score),  // REI
      IntegerToString(signals[8].score),  // PVSRA
      IntegerToString(signals[9].score),  // FibPivot
      // Decision
